...
exports.handleRegister = async function (req, res) {
    ...
    const sqlQuery = 'INSERT INTO public."User" (name, surname, username, email, password, admin) VALUES($1, $2, $3, $4, $5, $6)';
    const dodajResponse = await db.query(sqlQuery, [name, surname, username, email, hasher(password), 0]);
